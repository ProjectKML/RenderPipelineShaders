...
typedef enum RpsAccessFlagBits
{
    ...
    RPS_ACCESS_ALL_GPU_READONLY =
        ...
        RPS_ACCESS_CONSTANT_BUFFER_BIT | RPS_ACCESS_SHADER_RESOURCE_BIT | RPS_ACCESS_UNORDERED_ACCESS_READ_BIT |
        RPS_ACCESS_SHADING_RATE_BIT | RPS_ACCESS_DEPTH_READ_BIT | RPS_ACCESS_STENCIL_READ_BIT |
        RPS_ACCESS_COPY_SRC_BIT | RPS_ACCESS_RESOLVE_SRC_BIT | RPS_ACCESS_RAYTRACING_AS_READ_BIT | RPS_ACCESS_PRESENT_BIT,
